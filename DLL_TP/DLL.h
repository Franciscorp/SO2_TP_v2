...
#ifdef SO2_F01_EX8_EXPORTS//ver valor nas propriadades do preprocessador
#define DLL_IMP_API __declspec(dllexport)//quero exportar a funcao
#else
...
extern "C"
{
	...
	DLL_IMP_API int soma(int x, int y);
